...
<div class="row">
	<div class="col-4">
	<a href="javascript:void(0);" class="btn btn-primary btn-sm"><i class="fa fa-user"></i>  &nbsp;&nbsp; Register New Privillege</a>
</div>
<div class="col-12">
...
<th>User Type</th>
<th>Role</th>
<th>Has Privilledge</th>
<th>Action</th>
</tr>
</thead>
<tbody>
<tr>
<td>Super System Admin</td>
<td>Create Users</td>
<td><div class="form-check">
<input type="checkbox" class="form-check-input" id="exampleCheck1">
</div></td>
<td><a href="javascript:void"><i class="fa fa-save fa-2x text-success"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void"><i class="fa fa-times fa-2x text-danger"></i></a></td>
</tr>

<tr>
<td>System Admin</td>
<td>Create Hairdressers</td>
<td><div class="form-check">
<input type="checkbox" class="form-check-input" id="exampleCheck1">
</div></td>
<td><a href="javascript:void"><i class="fa fa-save fa-2x text-success"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void"><i class="fa fa-times fa-2x text-danger"></i></a></td>
...
<tr>
<td>Super System Admin</td>
<td>Access Financial Reports</td>
<td><div class="form-check">
<input type="checkbox" class="form-check-input" id="exampleCheck1">
</div></td>
<td><a href="javascript:void"><i class="fa fa-save fa-2x text-success"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void"><i class="fa fa-times fa-2x text-danger"></i></a></td>
