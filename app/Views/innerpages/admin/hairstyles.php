...
<tbody>
<?php  foreach ($hairstyles as $key => $hairstyle) {?>

<tr>
<td><?php echo $hairstyle->service_name; ?></td>
<td><?php echo strtoupper($hairstyle->service_category); ?></td>
<td><?php echo strtoupper($hairstyle->average_duration); ?></td>
<td><?php if(strcmp($hairstyle->parent_service, 'None') == 0):$type='Main Service';else:$type='Optional Service';endif;echo strtoupper($type); ?></td>
<td><?php echo 'R'.strtoupper($hairstyle->fee); ?></td>
<td class=""><?php echo $hairstyle->notes; ?></td>
<td class=""><?php echo $hairstyle->status; ?></td>
