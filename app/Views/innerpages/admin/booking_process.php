...
<li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Booking Process</a></li>
...
<span class="description">Online Booking - 7:29 PM Thur, 11 Dec 2023</span>
</div>

<p>
Made a booking through the Rooom Mobile Salon website.
</p>
...
<span class="description">Administrator Assignment - 7:30 PM Thur, 11 Dec 2023</span>
</div>

<p>
Auto assigned allocated Trish Moyo to hairstylist Lala Jimmy
</p>
</div>
...
<img class="img-circle img-bordered-sm" src="assets/admin/dist/img/user.png" alt="User Image">
<span class="username">
<a href="javascript:void(0);">Lala Jimmy</a>
<a href="javascript:void(0);" class="float-right btn-tool"><i class="fas fa-times"></i></a>
</span>
<span class="description">Client Acceptance - 8:00 PM Fri, 12 Dec 2023</span>
</div>

<p>
Lala Jimmy accepted the client by entering her Administrator code: RMS445588
</p>
</div>
...
<h3 class="timeline-header"><a href="javascript:void(0);">I, Zweli</a> sent Lala Jimmy a message</h3>
<div class="timeline-body">
Hi Lala, may you please process the booking within the next 4 days
</div>
<div class="timeline-footer">
<a href="javascript:void(0);" class="btn btn-primary btn-sm">Reply</a>
...
<h3 class="timeline-header border-0"><a href="javascript:void(0);">Trish Moyo</a> is waiting for Lala Jimmy to process the booking</h3>
</div>
</div>
...
<h3 class="timeline-header"><a href="javascript:void(0);">Lala Jimmy</a> sent a message to Trish Moyo</h3>
<div class="timeline-body">
...
<div class="timeline-footer">
<a href="javascript:void(0);" class="btn btn-primary btn-flat btn-sm">Reply</a>
</div>
</div>
</div>
...
<div class="timeline-item">
<span class="time"><i class="far fa-clock"></i> 27 mins ago</span>
<h3 class="timeline-header"><a href="javascript:void(0);">Trish Moyo</a> sent sent Lala Jimmy a message</h3>
<div class="timeline-body">
...
<div class="timeline-item">
<span class="time"><i class="far fa-clock"></i> 27 mins ago</span>
<h3 class="timeline-header"><a href="javascript:void(0);">Current Booking Status</a> </h3>
<div class="timeline-body">
Lala Jimmy is finalizing the booking details before sending them to the client 
</div>
<div class="timeline-footer">
<a href="javascript:void(0);" class="btn btn-success btn-flat btn-sm">Post An Update</a>
</div>
</div>
</div>
<!--  -->
...
<div class="form-group row">
<label for="inputSkills" class="col-sm-2 col-form-label">Optional Services</label>
<div class="col-sm-3">
	<div class="form-check">
		<input type="checkbox" class="form-check-input" id="exampleCheck1">
		<label class="form-check-label" for="exampleCheck1">Expression</label>
	</div>
</div>
<div class="col-sm-3">
	<div class="form-check">
		<input type="checkbox" class="form-check-input" id="exampleCheck1">
		<label class="form-check-label" for="exampleCheck1">Undo</label>
	</div>
</div>
</div>
<div class="form-group row">
