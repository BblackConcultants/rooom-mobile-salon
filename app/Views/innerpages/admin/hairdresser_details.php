...
<a href="<?php echo base_url('hairdresser_availability'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-calendar-alt"></i>  &nbsp;&nbsp; View <?php echo $button_text; ?> Booking Calendar</a>
</p>
	</div>
