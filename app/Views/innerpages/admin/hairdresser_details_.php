...
<p class="text-sm">Standard Working Hours
...
<a href="<?php echo base_url('hairdresser_availability'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-calendar-alt"></i>  &nbsp;&nbsp; Check <?php echo $button_text; ?> Availability</a>
</p>
	</div>
