...
<div class="row">
	<div class="col-4">
	<button type="button" class="btn btn-primary btn-sm"><i class="fa fa-user"></i>  &nbsp;&nbsp; Register New <?php echo $button_text;  ?> Service</button>
</div>
<div class="col-12">
...
<td><a href="<?php echo base_url('nail_service_details'); ?>"><i class="fas fa-eye"></i></a></td>
</tr>
<tr>
<td>19 Jan 2023</td>
<td>Nail Cleaning</td>
