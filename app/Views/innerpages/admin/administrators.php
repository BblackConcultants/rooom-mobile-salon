...
<div class="row">
	<div class="col-4">
	<button type="button" class="btn btn-primary btn-sm"><i class="fa fa-user"></i>  &nbsp;&nbsp; Register New <?php echo $button_text; ?></button>
</div>
<div class="col-12">
...
<th>No. Active Client Allocations</th>
<th>Status</th>
<th>View</th>
</tr>
</thead>
<tbody>
<tr>
<td>Trymore Mapindu</td>
<td>19 Oct 2023</td>
<td>25</td>
<td><label class="text-success">Active</label></td>
<td><a href="<?php echo base_url('administrator_details'); ?>"><i class="fas fa-eye"></i></a></td>
</tr>
<tr>
<td>Sharon Stone</td>
<td>19 Jan 2023</td>
<td>2</td>
<td><label class="text-warning">Suspended</label></td>
<td><a href="<?php echo base_url('administrator_details'); ?>"><i class="fas fa-eye"></i></a></td>
</tr>
<tr>
<td>Blessing Makuni</td>
<td>19 Nov 2023</td>
<td>5</td>
<td><label class="text-danger">Dismissed</label></td>
<td><a href="<?php echo base_url('administrator_details'); ?>"><i class="fas fa-eye"></i></a></td>
</tr>
</tbody>
</table>
